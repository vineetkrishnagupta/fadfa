...
export default function MyBusTicket() {
    ...
    let API = `http://localhost:5000/train/myticket?email=${localStorage.getItem("user_email")}`;
  ...
  const fecthApiData = async (url) => {
    ...
    try{
      ...
      console.log("Sorry!")
      document.getElementById("notfound_train_ticket").style = "display: ;";
    }
  }
  ...
  /><div className="container">
    ...
    <Link to="/myflight/ticket">
          ...
          <div id="notfound_train_ticket" className="card my-3"  style={{ display: "none"}}> <br />
        <>
