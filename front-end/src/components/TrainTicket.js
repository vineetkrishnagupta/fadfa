    ...
    <div className="container" id="Congratulations">
      <div className="alert alert-success" role="alert">
        ...
        <p>
          ...
          and your ticket to travel from <b> {localStorage.getItem("train_from_city")}</b>{" "}
          <i className="bi bi-arrow-left-right" /> <b> {localStorage.getItem("train_to_city")}</b>{" "}
          has been booked. We appreciate your trust in our services and we're
          delighted to be a part of your travel journey. You can now look forward
          to an amazing travel experience and create unforgettable memories.{" "}
        </p>
        <p>
      ...
      <div className="card" style={{ width: "100%", padding: 10 }}>
        <div className="row">
          <div className="col-12 col-md-4 col-xl-4 ">
            <div id="ticket_icone">
              <img
                src="https://thumbs.dreamstime.com/b/illustration-woman-reading-book-train-187211889.jpg"
                style={{ width: "100%" }}
                alt=""
              />
            </div>
          ...
          <div className="col-12 col-md-8 col-xl-8 ">
              ...
              <tbody>
                <tr style={{ borderBottom: "2px solid red" }}>
                  <th>
                    <h4>
                      <b>
                        <i className="bi bi-train-front-fill" /> Train Tickets
                      </b>
                    </h4>
                    <h6>{localStorage.getItem("train_name")}</h6>
                  </th>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <h6>
                      <b>
                        <i className="bi bi-card-heading" /> Train No :
                      </b>{" "}
                      {localStorage.getItem("train_number")}
                    </h6>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <h6>
                      ...
                      {localStorage.getItem("train_departure_date")}
                    </h6>
                  </td>
                </tr>
                <tr>
            ...
            <div id="print_tickets_button">
              ...
              <Link to="/"><button id ="backbtn" className="btn btn-dark mx-2">Back</button></Link>
